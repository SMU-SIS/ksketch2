...
{
	public class KSketchStyleSheet
	{
		//==========HOME VIEW variables==========
		//Logo
		...
		//Main buttons
		public static var HOME_BUTTON_SIZE:int = 15;
		public static var HOME_BUTTON_FONTSIZE:int = 14;
		...
		public static var CANVAS_SCALE:Number = 0.8;
		...
		public static var FONT_LARGE:int = 26;
		public static var FONT_MEDIUM:int = 18;
		public static var FONT_STANDARD:int = 14;
		public static var FONT_SMALL:Number = 12;
		public static var FONT_XSMALL:int = 10;
		
		
		public static function scaleHome(scaleFactor:Number):void
		{
			...
			HOME_BUTTON_SIZE = 15 * scaleFactor;
			HOME_BUTTON_FONTSIZE = 14 * scaleFactor;
			
			LIST_SKETCH_FONT = 20 * scaleFactor;
			LIST_SKETCH_LINE = 1000 * scaleFactor;
			LIST_SKETCH_WIDTH = 74 * scaleFactor;
			LIST_SKETCH_HEIGHT = 120 * scaleFactor;
			LIST_SKETCH_IMAGE_WIDTH = 160 * scaleFactor;
			LIST_SKETCH_IMAGE_HEIGHT = 90 * scaleFactor;
		}
		
		public static function scaleCanvas(scaleFactor:Number):void
		{
			SCALE = 1.9;
			CANVAS_SCALE = 1.2 / scaleFactor;
			...
			TIMEBAR_GAP_CONTEXTMENU_DOUBLE = 15 * scaleFactor;
			...
			MAGNIFIER_CIRCLE_1 = 18 * scaleFactor;
			MAGNIFIER_CIRCLE_2 = 14 * scaleFactor;
			...
			POPUP_SEPARATOR_LINE = 60 * scaleFactor;
			...
			WIDGET_CENTROID_SIZE = 10 * scaleFactor;
			
			BUTTON_SIZE = 15 * scaleFactor;
			...
			DIALOG_MEASUREMENT_25 = 50 * scaleFactor;
		...
		public static function scaleFont(scaleFactor:Number):void
		{
			FONT_LARGE = 26 * scaleFactor;
			FONT_MEDIUM = 18 * scaleFactor;
			FONT_STANDARD = 14 * scaleFactor
			FONT_SMALL = 12 * scaleFactor;
			FONT_XSMALL = 10 * scaleFactor;
		}
	}
}