...
{	
	...
	public class KUngroupUtil
	{
		 ...
		 */
		public static function ungroupDynamic(model:KModel, root:KGroup, 
		 ...
		 */
		public static function removeFutureParentKeys(object:KObject,time:Number):IModelOperation
		{
		 ...
		 */
		public static function removeSingletonGroups(model:KModel,group:KGroup,
