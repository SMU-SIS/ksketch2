...
package
{
	...
	{						
		public function OptionCanvas(mainCanvas:KSketch2Canvas)
		{				
			super();
		...
		private function _createGroupingGroup(mainCanvas:KSketch2Canvas):VGroup
		{
		...
		private function _createAnimationGroup(mainCanvas:KSketch2Canvas):VGroup
		{
			var vg:VGroup = new VGroup();
