...
package sg.edu.smu.playsketch.exportTools
{
	...
	public class SimpleFlvWriter
	{
		...
		private var totalProgressTime:int;
		private var pBitmdata:BitmapData;
		...
		public var ff:FileReference=new FileReference();			
		...
		public function createFile(pWidth:int, pHeight:int, pFramesPerSecond:Number, pDurationInSeconds:Number=0):void
		{
			...
			bytes.writeUnsignedInt(previousTagSize);
			bytes.writeBytes(flvTagOnMetaData());	
